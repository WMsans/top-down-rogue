...
func _register_modifier_zone(controller: CardEffects.CardEffectController, card: PanelContainer, slot_idx: int, modifier: Modifier) -> void:
...
func _stash_modifier_for_zone(zone_id: String, modifier: Modifier, controller: CardEffects.CardEffectController) -> void:
...
func _on_modifier_zone_entered(zone_id: String, controller: CardEffects.CardEffectController) -> void:
	var zone_map: Dictionary = controller.get_meta("zone_modifiers", {})
...
func _on_modifier_zone_exited(_controller: CardEffects.CardEffectController) -> void:
	_cancel_modifier_tooltip()
