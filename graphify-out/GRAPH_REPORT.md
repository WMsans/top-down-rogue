...
- **Weapon System Architecture (Melee, Manager, Visual, Modifier)** — plans_2026_04_12_melee_weapon_melee_weapon, plans_2026_04_12_weapon_manager_decoupling_weapon_manager, plans_2026_04_12_soul_knight_melee_weapon_weapon_visual, plans_2026_04_17_weapon_modifier_system_modifier, plans_2026_04_15_weapon_ui_weapon_base_stats [INFERRED 0.85]
- **GPU Terrain Simulation Pipeline (Compute, Chunks, Collision, Modifier, Reader)** — plans_2026_04_14_world_manager_refactor_compute_device, plans_2026_04_14_world_manager_refactor_chunk_manager, plans_2026_04_14_world_manager_refactor_collision_manager, plans_2026_04_14_world_manager_refactor_terrain_modifier, plans_2026_04_14_world_manager_refactor_terrain_reader [EXTRACTED 1.00]
- **Noita-Style Level Generation (Biome->SectorGrid->TemplatePack->Spawn)** — plans_2026_04_27_phase5_level_system_biome_def, plans_2026_04_27_phase5_level_system_sector_grid, plans_2026_04_27_phase5_level_system_template_pack, plans_2026_04_27_phase5_level_system_spawn_dispatcher, plans_2026_04_27_phase5_level_system_level_manager [EXTRACTED 1.00]
- **GPU Compute Coalescing Pattern** — plans_2026_05_20_coalesced_light_readback_coalesced_light, plans_2026_05_21_terrain_collision_coalescing_coalesced_collider, plans_2026_05_19_fps_perf_pass_double_buffered_probe [INFERRED 0.85]
- **Set-Piece Room Architecture** — plans_2026_05_14_part2_set_piece_rooms_arena_composition, plans_2026_05_14_part2_set_piece_rooms_arena_feature, plans_2026_05_14_part2_set_piece_rooms_arena_region, plans_2026_05_17_organic_set_piece_rooms_composition_dispatcher, plans_2026_05_17_organic_set_piece_rooms_cavern_carve, plans_2026_05_17_organic_set_piece_rooms_sector_grid_claim [INFERRED 0.85]
- **Enemy Combat Feedback Pipeline** — plans_2026_05_04_phase4_enemies_combat_plan_enemy_fsm, plans_2026_05_09_hit_feedback_blood_hit_flash_squash, plans_2026_05_09_hit_feedback_blood_place_blood, plans_2026_05_12_parry_and_projectile_block_parry, plans_2026_05_12_parry_and_projectile_block_projectile_block, plans_2026_05_09_material_hardness_terrain_impact [INFERRED 0.75]
- **Melee Attack Pipeline** —  [INFERRED]
- **Fluid Material Framework** —  [INFERRED]
- **Material Data Pipeline** —  [INFERRED]
...
- **Combat Feedback Ecosystem** — specs_2026_05_09_hit_feedback_blood_design_hit_feedback_blood_system, specs_2026_05_09_material_hardness_design_terrain_impact, specs_2026_05_12_parry_and_projectile_block_design_parry_and_projectile_block, specs_2026_05_11_enemy_intent_indicator_design_enemy_intent_indicator, specs_2026_05_19_oil_explosion_cascade_design_oil_explosion_cascade [INFERRED 0.85]
...
Cohesion: 0.09
Nodes (25): BossEnemy, DropTable, Elite System, Enemy FSM, MeleeEnemy, MeleeWeapon, Projectile, RangedEnemy (+17 more)
...
Cohesion: 0.16
Nodes (14): BackBufferCopy Node, Entity Occlusion in Fog, FogManager, fog_of_war.gdshader, FogSprite, blend_rect Light Stamping, Fog Of War, Glowing Lights (+6 more)

### Community 23 - "Walkable Space & Props"
Cohesion: 0.15
...
Cohesion: 0.22
Nodes (9): Aggro Contagion, Attack Tokens (Hades-style), Per-Enemy Damage Scale, EncounterDirector, Enemy (base entity), RangedEnemy, Rubber-Band Catch-Up Speed, Surround Slot Assignment (+1 more)

### Community 35 - "Damage Vignette & Feedback"
Cohesion: 0.22
...
Cohesion: 0.31
Nodes (9): PlayerInventory, Cheat Command, CommandRegistry, ConsoleManager Autoload, Tab Autocomplete, Creative Mode Noclip, GameModeManager Autoload, Gamemode System (+1 more)

### Community 38 - "Wall AO & Baked Lighting"
Cohesion: 0.22
...
Cohesion: 0.40
Nodes (6): Attack Token Chicken-and-Egg Deadlock, Dynamic Aggression Tokens (aggression_delta), EncounterDirector, Ring Strafe / Orbit Mechanics, Maximum Aggression (all enemies attack freely), Remove Attack Tokens Design

### Community 48 - "Gold & Biome & Def"
Cohesion: 0.33
Nodes (6): BiomeDef.gold_multiplier, Boss Bonus Gold, Chest Gold Drops, DropTable (income helpers), Economy Balancing System, ShopPricing (floor-scaled prices)

### Community 49 - "Decordef & Flickerlight & Floor"
Cohesion: 0.53
...
Cohesion: 0.40
Nodes (5): TerrainSurface (material placement adapter), GasVent Script (indestructible periodic gas emitter), FlameLobberWeapon (lob-splat lava), ProjectileBehavior.on_expire() Hook, SplatBehavior (on-impact material placement)

### Community 61 - "Specs & 2026 & Economy"
Cohesion: 0.40
Nodes (5): Economy Anchor (floor-1 ~330g, ~2-3 shop items), Floor-Scaling Multipliers (income 1+0.12(n-1), price 1+0.18(n-1)), Gold Drop Retune (EASY/NORMAL/HARD tiers), Per-Biome Gold Multiplier, Shop Price Retune (modifier/weapon/removal)

### Community 62 - "Specs & 2026 & Minimap"
Cohesion: 0.40
Nodes (5): Persistent Fog of War (circular reveal), HUD TopRight VBox Layout (Minimap + Weapon clusters), MinimapModel (RefCounted, world-data layer), Minimap POIs (boss/shop/elite arenas), Minimap Widget (Control, 180x180, shader-based)

### Community 63 - "Card & Juicy & Balatro"
Cohesion: 0.40
Nodes (5): Card Controller, fake_3D Shader, animated_root Export, JuicyPanel, WeaponInfoPopup

### Community 64 - "Hit & Feedback & Blood"
Cohesion: 0.40
Nodes (5): Enemy base class (enemy.gd), Enemy hit flash & squash animation, WINDUP state indicator lifecycle, Enemy._parry_stun_remaining field, DropTable.roll_modifier_for_enemy

### Community 65 - "Specs & 2026 & Ranged"
Cohesion: 0.50
Nodes (4): AimedBurstWeapon, Burst Engine (RangedWeapon burst timeline), FanWeapon, SplitShotWeapon

### Community 66 - "Specs & 2026 & Ranged"
Cohesion: 0.50
Nodes (4): Sniper Cover Destruction / Terrain Penetration, SniperEnemy, SniperWeapon, Tracking Aim-Line Telegraph with Lock

### Community 67 - "Specs & 2026 & Melee"
Cohesion: 0.50
Nodes (4): _dash_hit / _dash_done Flags, Lunge Body-Check Mechanic, LungeEnemy, _moves_during_attack() Hook

### Community 68 - "Cheat & Command & Console"
Cohesion: 0.50
Nodes (4): Cheat Command System (Console), CommandRegistry (Parse & Suggest), ConsoleCommand Base Class, ConsoleManager Autoload

### Community 69 - "Hit & Feedback & Blood"
Cohesion: 0.50
Nodes (4): Hit Flash and Squash, HitReaction, MAT_BLOOD, place_blood

### Community 70 - "Part2 & Set & Piece"
Cohesion: 0.50
Nodes (4): MAT_EXPLODE_WAVE, MAT_OIL, Oil Fluid Sim, Explode Wave Shell

### Community 71 - "Swing & Melee & Overshoot"
Cohesion: 0.50
Nodes (4): Bouncy Melee Swing Animation, Elastic Overshoot Swing Animation, MeleeSwingEffect (Polygon2D blade), WeaponVisual (swing animation)

### Community 72 - "Parry & Projectile & Block"
Cohesion: 0.50
Nodes (4): MeleeWeapon swing phase exposure, Parry window (first ~0.1s of swing), PlayerController.try_parry method, PhysicsServer2D.intersect_shape for melee hits

### Community 73 - "Props & Boundary & Mat"
Cohesion: 0.50
...
### Community 76 - "Specs & 2026 & Modifier"
Cohesion: 0.67
Nodes (3): ChainSparkModifier (bespoke, chains lightning), LightningArcFX (self-drawing arc VFX), on_crit Modifier Hook

### Community 77 - "Specs & 2026 & Native"
Cohesion: 0.67
Nodes (3): ChainBehavior (lightning fork between enemies), CombatUtil.nearest_attackables() Static Helper, TeslaGunWeapon (chain/fork bolt)

### Community 78 - "Hciu & Spiral & Nudge"
Cohesion: 0.67
Nodes (3): Spiral Nudge Resolution, CaveSpawner (delegates to SpawnValidation), SpawnValidation (footprint helper)

### Community 79 - "Lunge & Hciu & Moves"
Cohesion: 0.67
Nodes (3): _moves_during_attack() Hook, Lunge Dash Body-Check, LungeEnemy (dash attacker)

### Community 80 - "Gas & Vent & Oil"
Cohesion: 0.67
Nodes (3): GasVent (periodic emitter), OilBarrel (destructible prop), Poisoned Status Effect

### Community 81 - "Steam & Reaction & Mat"
Cohesion: 0.67
Nodes (3): MAT_STEAM Material, Reaction: Lightning + Wet -> Steam, Reaction: Steam Smothers Fire

### Community 82 - "Status & Timed & Component"
Cohesion: 0.67
Nodes (3): StatusComponent (timed statuses), StatusDef.Mode (STAIN vs TIMED), Timed Status Model

### Community 83 - "Props & Boundary & Biome"
Cohesion: 0.67
Nodes (3): Biome props placement (material + entity), NO_PROPS conflict mask (chunk_flags_tex), Powder Simulation (ice/sand, idle piles)

### Community 84 - "Organic & Set & Piece"
Cohesion: 0.67
Nodes (3): Boss Arena 2048x2048 (organic cavern), stage_cavern_carve GPU stage (angular noise), Boss arena shrink (r=960→300)

### Community 85 - "Fps & Perf & Pass"
Cohesion: 0.67
Nodes (3): Hazard sub-cell map (per-chunk bitmask), TerrainDamageReceiver (per-enemy), Entity damage from oil + explode wave

### Community 86 - "Terrain & Collision & Coalescing"
Cohesion: 0.67
Nodes (3): Dirty tracking for terrain collisions, COLLISION_REBUILD_INTERVAL removal, TerrainCollisionHelper rewrite (dirty tracking)

### Community 87 - "Per & Weapon & Rarity"
Cohesion: 0.67
