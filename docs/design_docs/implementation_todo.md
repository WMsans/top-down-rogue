...
~~ means that this task is finished.
...
|----------|------------|------|-------------|
~~| P0 | High | Pixel-based terrain rendering | Implement destructible pixel-terrain similar to Noita |
~~| P0 | High | Terrain carving system | Allow melee swings to modify/cut through terrain |
~~| P0 | High | Material system foundation | Create base material types (solid, liquid, gas) |
~~| P1 | Medium | Terrain generation (caves) | Procedural cave generation for levels |
~~| P1 | High | Fluid simulation | Water, lava, and other liquid dynamics |
~~| P1 | High | Gas simulation | Toxic gas and other atmospheric effects |
~~| P2 | High | Material interaction chains | Fire burns gas, lava melts terrain, etc. |
...
| Priority | Difficulty | Task | Description |
|----------|------------|------|-------------|
| P0 | Medium | Weapon base stats | Damage, swing speed, reach, base damage type |
| P0 | Medium | 3-slot modifier system | Weapon holds up to 3 modifier slots |
| P1 | Medium | Weapon pickup/drops | Enemies and chests drop weapons |
